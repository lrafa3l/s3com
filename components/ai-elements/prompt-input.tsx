...
export const PromptInputTextarea = ({
  ...
  return (
    <Textarea
      className={cn(
        "w-full resize-none rounded-none border-none p-5 shadow-none outline-none ring-0",
...
export const PromptInputModelSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      "border-none rounded-full bg-transparent font-medium text-muted-foreground shadow-none transition-colors",
